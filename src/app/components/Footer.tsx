      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm text-gray-400">Your trusted partner in finding exceptional rental properties.</p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/" className="text-gray-400 hover:text-amber-500 transition-colors">Properties</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-gray-400 hover:text-amber-500 transition-colors">Residential Rentals</a></li>
              ...
              <li><a href="#" className="text-gray-400 hover:text-amber-500 transition-colors">Tenant Services</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-amber-500 hover:text-black text-gray-400 transition-colors">
